...
const config = {
    ...
    walletName: `${process.env.USERNAME || 'MafilApp1'}_wallet`,
    ...
    userInformation: {
        name: process.env.NAME || 'MafilApp1',
        email: process.env.EMAIL || 'Mafil@m.com',
        ...
        username: process.env.USERNAME || 'MafilApp1',
